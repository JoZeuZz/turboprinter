...
metrics_snapshots = Table(
    ...
    Column("external_video_id", String, nullable=True),
    Column("platform", String, nullable=False, server_default="youtube"),
    Column("collected_at", DateTime, nullable=True),
    Column("captured_at", DateTime, nullable=True),
    Column("age_window", String, nullable=True),
    Column("views", Integer, nullable=True),
    Column("impressions", Integer, nullable=True),
    Column("ctr", Float, nullable=True),
    Column("average_view_duration", Float, nullable=True),
    Column("average_view_percentage", Float, nullable=True),
    Column("likes", Integer, nullable=True),
    Column("comments", Integer, nullable=True),
    Column("shares", Integer, nullable=True),
    Column("subscribers_gained", Integer, nullable=True),
    Column("estimated_revenue", Float, nullable=True),
    Column("rpm", Float, nullable=True),
    Column("metadata_json", Text, nullable=True),
